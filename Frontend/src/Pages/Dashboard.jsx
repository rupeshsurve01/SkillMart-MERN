...
const Dashboard = () => {
  return (
    <div>
      ...
      {/* HERO SECTION */}
      <div className="relative min-h-[60vh] sm:min-h-screen flex items-start sm:items-center justify-center bg-gradient-to-br from-gray-100 via-white to-gray-200 px-4 sm:px-6 pt-20 sm:pt-0">
        {" "}
        ...
        <div className="relative z-10 text-center max-w-5xl">
          ...
          <p className="mt-6 text-base sm:text-lg md:text-xl text-gray-400 px-2">
            A marketplace where passionate creators teach, and ambitious
            learners grow.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 mt-10 text-white">
            <div className="text-center">
              <h3 className="text-2xl sm:text-3xl font-bold text-[#6f26eb]">
                50+
              </h3>
